...
const getWhatsAppUrl = (phone) => {
  const defaultPhone = "(+62) 811 1234 5678"
  const raw = phone || defaultPhone
  // Ambil hanya angka saja
  let cleaned = raw.replace(/\D/g, '')
  
  // Jika diawali dengan '0', ganti menjadi '62' (kode Indonesia)
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <div className="contact-item">
              <h4>Telepon / WA</h4>
              <p>
                <a href={getWhatsAppUrl(content.phone)} target="_blank" rel="noopener noreferrer">
                  {content.phone || "(+62) 811 1234 5678"}
                </a>
              </p>
            </div>
            ...
            <div className="social-links">
              ...
              <a href={content.tiktok || "#"} className="social-link-item" target="_blank" rel="noopener noreferrer">Tiktok</a>
