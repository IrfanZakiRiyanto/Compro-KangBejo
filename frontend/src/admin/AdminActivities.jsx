  ...
  return (
    <div>
      ...
      <div className="adm-page-header">
        <div>
          <h1 className="adm-page-title">Kegiatan</h1>
          <p className="adm-page-subtitle">Kelola daftar kegiatan yang bisa diikuti di Desa Wisata</p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 32, alignItems: "start" }}>
        ...
        <div className="adm-card">
          <div className="adm-card-header">
            <h2 className="adm-card-title">Daftar Kegiatan</h2>
        ...
        <div className="adm-modal-overlay" onClick={resetForm}>
          <div className="adm-modal" onClick={e => e.stopPropagation()}>
            <div className="adm-modal-header">
              <h2 className="adm-modal-title">{editingId ? "Edit Kegiatan" : "Tambah Kegiatan"}</h2>
              <button className="adm-modal-close" onClick={resetForm}>&times;</button>
            </div>
            <form onSubmit={handleSubmit}>
              <div className="adm-form-group">
                <label className="adm-label">Nama Kegiatan</label>
              ...
              <div className="adm-form-row">
                <div className="adm-form-group">
                  ...
                  <input className="adm-input" value={formData.icon} onChange={e => setFormData({...formData, icon: e.target.value})} placeholder="Contoh: activity" />
                </div>
                <div className="adm-form-group">
